...
get_stock_analysis = Task(
    description=("Analyze the recent performance of the stock: {stock}. Use the live stock information tool to retrieve"
                 "current price, percentage change, trading volume, and other market data. Provide a summary on how the stock"
                 "is performing today and and highlight any key observations from the data"),
    expected_output=(
